...
.doctabs{display:flex;flex-wrap:wrap;border-bottom:1px solid var(--border);margin:0 0 var(--sp-8);}
...
@media (max-width:680px){.doctabs a{padding:var(--sp-2) var(--sp-3);font-size:12.5px;}}
